...
import { getCurrentLocation, LocationData, sendLocationToServerOnce } from './src/services/location';
...
function MainApp() {
  ...
  setSosLoading(true);
  try {
    // 1) send phone GPS to the relay server
    await sendLocationToServerOnce();

    // 2) existing SOS logic (no changes)
